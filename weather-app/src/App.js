  ...
  useEffect(() => {
    ...
    const fetchWeather = async () => {
      ...
      const result = await axios
        (
        `http://api.openweathermap.org/data/2.5/weather?q=Stockholm&units=metric&appid=539ef42e6ef65b779c987dc2f30ba004`
        )

        const longResult = await axios
        (
        `http://api.openweathermap.org/data/2.5/forecast?q=Stockholm&ctn=2&units=metric&appid=539ef42e6ef65b779c987dc2f30ba004`
        )
